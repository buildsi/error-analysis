...
def get_spec(id):
  spec_file = os.path.join(os.getcwd(), "data", "spec_files", "errors", "%s.yaml" % id)
...
def get_cluster_data():
  ...
  data_dir = os.path.join(os.getcwd(), "data", "clusters", "dbstream", cluster_assign_fname)
...
def main():
  ...
  for cluster_id in range(num_clusters):
      ...
      cluster_meta = os.path.join(
          cluster_dir, "cluster-feats-%s.json" % cluster_id
      )
